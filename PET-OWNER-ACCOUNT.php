...
<html style="font-size: 16px;">
  <head>
    ...
    <title>PET OWNER ACCOUNT</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="PET-OWNER-ACCOUNT.css" media="screen">
    ...
    <meta property="og:title" content="PET OWNER ACCOUNT">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-1-base u-header" id="sec-c7a2"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-5c18">
          ...
          <table class="u-table-entity u-table-entity-1">
            ...
            <thead class="u-palette-4-base u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Contact Number</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Address</th>
              </tr>
            </thead>
			...
			<?php
                ...
                <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-7">'.$row['FullName'].'</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">'.$row['Username'].'</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">'.$row['ContactNumber'].'</td>
